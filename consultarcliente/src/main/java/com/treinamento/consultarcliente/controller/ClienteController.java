package com.treinamento.consultarcliente.controller;
...
import com.treinamento.consultarcliente.service.ClienteService;
@RestController
...
public class ClienteController {
	...
	public Page<Cliente> list(@PageableDefault(page=0,size=10)Pageable page,@RequestParam(required=false)String nome){
		return clienteService.listAllCliente(page,nome);
	}
